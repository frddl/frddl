...
On the side I run **[ThirteenTabs](https://thirteentabs.com)**, a small studio building content-first reference sites, and **[Skiplink](https://skiplink.dev)** — accessibility scanning for teams: a hosted API, a CLI, and CI checks on top of axe-core.
